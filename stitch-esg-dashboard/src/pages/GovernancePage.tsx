    ...
    <DashboardLayout>
      <div className="mb-8">
        ...
        <p className="text-slate-500 dark:text-slate-400">
          Gerencie e monitore a ética, transparência e conformidade da <span className="text-primary font-bold">{company?.name}</span>.
        </p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
        <Card variant="chunky">
          <div className="flex items-center justify-between mb-4">
            <span className="text-[10px] font-black text-slate-400 uppercase tracking-widest">Score Governança</span>
          ...
          <p className="text-governance text-[10px] font-black uppercase tracking-wider mt-1">Nível: Mestre da Ética</p>
        </Card>

        <Card variant="chunky">
          <div className="flex items-center justify-between mb-4">
            <span className="text-[10px] font-black text-slate-400 uppercase tracking-widest">Conformidade</span>
            <div className="p-2 bg-indigo-500/10 text-indigo-500 rounded-lg">
              <Scale size={20} />
            </div>
          </div>
          <p className="text-3xl font-black text-slate-900 dark:text-slate-100">100%</p>
          <p className="text-slate-400 text-[10px] font-black uppercase tracking-wider mt-1">Treinamento Anticorrupção</p>
        </Card>
      ...
      <Card title="Próximas Missões de Governança">
        <div className="space-y-4">
          {[
            { icon: ShieldAlert, title: 'Revisão do Código de Conduta', points: '+400 XP', status: 'Em Curso' },
            { icon: Scale, title: 'Implementação de Canal de Denúncias', points: '+600 XP', status: 'Pendente' },
          ].map((mission, i) => (
